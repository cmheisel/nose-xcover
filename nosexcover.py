...
class XCoverage(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option('--cover-xml', action='store_true',
                          ...
                          dest='cover_xml',
                          help="Produce Cobertura style XML information")
    ...
    def configure(self, options, config):
        ...
        self.cover_xml = options.cover_xml 
        if options.cover_xml:
            log.debug("Will produce coverage XML report in coverage.xml")
